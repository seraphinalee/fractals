...
[a,b]=lambdamap(eigvals(600),r,4);
[extension,newplotting_points,newpoints,newcells] = funcmap(V(:,600),min(b),r,4,plotting_points,points,cells);
[a,b]=lambdamap(min(b),r,5);
[extension,newplotting_points,~,~] = funcmap(extension,min(b),r,5,newplotting_points,newpoints,newcells);
...
hold on
gasketgraph(plotting_points,V(:,600));
%subplot(1,2,2)
%for i =1:30
